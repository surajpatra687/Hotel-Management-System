...
int main(){     // MAIN FUNCTION	
	...
	printf("\t\t*                                               *\n");
	printf("\t\t*       -----------------------------           *\n");
	printf("\t\t*        WELCOME TO HOTEL SUNRISE CAVE          *\n");
	printf("\t\t*       -----------------------------           *\n");
	printf("\t\t*                                               *\n");
	printf("\t\t*                                               *\n");
	printf("\t\t*                                               *\n");
	printf("\t\t*          ENJOY YOUR DREAM VACATION            *\n");
	printf("\t\t*   LOVE WHERE YOU LIVE,AND WHO YOU LIVE WITH   *\n");
	printf("\t\t*     CONTACT IN:91-7655010735,9777262692       *\n");
	printf("\t\t*************************************************\n\n\n");
		for(i=0;i<80;i++)
		printf("-");
